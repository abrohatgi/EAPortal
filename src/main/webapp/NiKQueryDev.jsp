...
<html lang="en">
    ...
    <body>
        ...
        <iframe width="100%" height=900px scrolling="yes" sandbox="allow-forms allow-same-origin allow-scripts" src="https://www.usaa.com/inet/pages/our-products-main?wa_ref=pub_global_products_viewall" id="proxy_frame" frameborder="0"></iframe>
        ...
        <script>
            ...
            $(document).on('click', '[rel="popover2"]', function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'http://ibm-dqa12.grid.nuance.com:8087/context?projectId=usaa',
                    //data: message,
                    dataType: 'json',
                    success: function (res)
                    {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: 'http://ibm-dqa12.grid.nuance.com:8087/question?contextId=' + encodeURIComponent(res) + '&question=' + encodeURIComponent(question),
                            //data: message,
