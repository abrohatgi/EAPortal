...
<%
    ...
    if (ProjectURL == null || ProjectURL.isEmpty() || ProjectURL == "") {
        ProjectURL = "https://www.ato.gov.au/";
    }
...
<html lang="en">
    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                    <img src="https://dl.dropboxusercontent.com/u/19978973/Kengine.png" class="pull-right">
                </div>
                <div class="col-md-8">
                    <br><br>
                    <div class="row">
                        <form>
                            <div class="row">
                                <div class="col-md-12">
                                    <label id="label1" class="form-label"><div class="nina-text">Kngine - Ask me a question ?</div></label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div id="ifYes1" style="display:none">
                                        <label id="label2" class="form-label"><div class="nina-text">Kngine : Here is what i found: </div></label>
                                    </div>
        ...
        <script>
            ...
            $(document).on('click', '[rel="popover2"]', function () {
                ...
                {
                    document.getElementById('label2').innerHTML = '<div class ="nina-text">Kngine : In order to help, please type your question below.</div>';
                    return;
                }
                /*
                 var regex = /\s+/gi;
                ...
                $.ajax({
                    type: 'GET',
                    url: 'http://ibm-dqa14.grid.nuance.com:8080/nik2/question?contextId=' + encodeURIComponent(res) + '&question=' + encodeURIComponent(question),
                    //data: message,
                ...
                $('[rel="popover"]').bind('click', function () {
                    ...
                    $.ajax({
                        type: 'GET',
                                ...
                                url: 'http://kngine.com/evalapi.ashx?q=' + question + '&website=usaa',
                                //data: message,
                                //url: 'http://demo7319927.mockable.io/queryResponse',
                                dataType: 'json',
                                success: function (data) {
                                        ...
                                        console.log("title : " + data.AnswerCandidate.AnswerTitle);
                                        console.log("TextAnswer : " + data.AnswerCandidate.TextAnswer);
                                        console.log("HTMLAnswer : " + data.AnswerCandidate.HTMLAnswer);
                                        console.log("AnswerURL : " + data.AnswerCandidate.AnswerURL);

                                        iFrameArray.push(data.AnswerCandidate.AnswerURL);

                                        var titleHTML = '<div class="response-title">' + data.AnswerCandidate.AnswerTitle + '</div>';
                                        var summaryHTML = '<div class="response-summary">' + data.AnswerCandidate.TextAnswer + '</div>';
                                        // var frameHTML = '<iframe width="100%" height=300px scrolling="yes" sandbox="allow-forms allow-same-origin allow-scripts" src="' + data[i].answer.presentationUrl + '" id="proxy_frame" frameborder="0"></iframe>'
