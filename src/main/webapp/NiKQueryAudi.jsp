...
<html lang="en">
    ...
    <body>
        ...
        <iframe width="100%" height=900px scrolling="yes" sandbox="allow-forms allow-same-origin allow-scripts" src="http://www.audihelp.com/" id="proxy_frame" frameborder="0"></iframe>
        ...
        <script>
            ...
            $(document).on('click', '[rel="popover2"]', function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'http://ibm-dqa14.grid.nuance.com:8047/context?projectId=audihelp',
                    //data: message,
                    dataType: 'json',
                    success: function (res)
                    {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: 'http://ibm-dqa14.grid.nuance.com:8047/question?contextId=' + encodeURIComponent(res) + '&question=' + encodeURIComponent(question),
                            //data: message,
